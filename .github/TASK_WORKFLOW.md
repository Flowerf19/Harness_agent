...
- Đọc docs liên quan: [docker/ARCHITECTURE.md](../docker/ARCHITECTURE.md), [README_BASH_EXECUTOR.md](../README_BASH_EXECUTOR.md).

## 2) Design

- Ghi rõ assumptions.
- Nếu phát hiện "facts" mới về repo (ports, env vars, boundaries), cập nhật [MEMORY.md](MEMORY.md).
...
- Chạy tests phù hợp theo [TESTING_GUIDE.md](TESTING_GUIDE.md).
