...
- **Trí nhớ 3 tầng**: Redis (hội thoại) → Qdrant (kiến thức) → Markdown (hồ sơ người dùng)
...
- `.agents/README.md` (index + thứ tự đọc)
...
├── shared/                      # Shared base image + Redis/Qdrant/CodeBox/Bash executor compose
│   ├── Dockerfile.base
