<tool_description>
Khi user muốn đổi persona, vai trò, tính cách, hoặc giọng nói bot.
</tool_description>
...
- User yêu cầu đổi identity, tính cách, vai trò, cách xưng hô, phong cách nói, emoji, hoặc độ dài câu trả lời.
...
- Chỉ cần trả lời câu hỏi thông thường.
