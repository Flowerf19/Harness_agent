...
class GeminiService:
    def __init__(self):
        ...
        self.api_url = os.getenv('GEMINI_API_URL', 'https://generativelanguage.googleapis.com/v1beta/models')
    ...
    async def generate_response(self, prompt: str, user_id: str = None, conversation_context: str = "") -> str:
        if not self.api_key:
    ...
    def _build_full_prompt(self, user_message: str, user_id: str = None, conversation_context: str = "") -> str:
